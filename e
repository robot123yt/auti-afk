...
getgenv().Accounts = {OWNER = 'XK5NG', STAND = "amen_bot"} This is just the example dont put the username here ]]

--\\-- Accounts --//--

getgenv().Accounts = {OWNER = 'robot123hhwh', STAND = "robot123hhwhh"}
